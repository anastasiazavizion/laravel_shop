...
<template>
    ...
    <div class="sm:flex sm:gap-8 sm:justify-center sm:align-items-center">
        ...
        <router-link v-if="is('admin') && authenticated" :class="routerLinkClass" :to="{name:'admin.orders.index'}">
            Orders
        </router-link>
    ...
    <div>
        <router-link :class="routerLinkClass" class="relative ml-auto" :to="{name:'cart.index'}">
